...
public class OrderController
{
    ...
    public String order() throws JsonParseException
    {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("message", "I am order service");
        jsonObject.put("message-2", restTemplate.exchange("http://localhost:8081/pizza", HttpMethod.GET, null, String.class).getBody());
        jsonObject.put("message-3", restTemplate.exchange("http://localhost:8082/user", HttpMethod.GET, null, String.class).getBody());
        return jsonObject.toString();
    }
